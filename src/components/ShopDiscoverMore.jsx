  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-14">
      ...
      <h2 className="bg-gradient-to-r from-pink-500 via-pink-400 to-pink-300 
                     bg-clip-text text-transparent text-4xl font-bold text-center mb-10">
